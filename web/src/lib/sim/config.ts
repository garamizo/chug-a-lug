...
export type SimConfig = {
  version: 1; run: string; source: 'fixture'; root: string; runDir: string; project: string;
...
export function buildSimConfig(input: {
  ...
  if (input.source !== 'fixture') invalid('SOURCE (fixture only until recording support lands)');
  ...
  return { version: 1, run: input.run, source: 'fixture', root: input.root, runDir,
